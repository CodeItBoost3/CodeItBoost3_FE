...
const handleCreatePost = async () => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-10 z-20">
      <div className="relative w-[90%] md:w-[65%] min-h-[70%] h-auto px-6 md:px-[65px] pt-[40px] pb-[70px] bg-white rounded-[20px] shadow-md border border-darkWhite flex flex-col justify-start items-center overflow-hidden">
